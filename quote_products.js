...
window.QUOTE_PRODUCTS = [
  ...
  { id: 'legacy-cat-178661556928610', cat: '스피커', brand: 'Audiocenter', name: 'DSL 45', price: 2100000, isPrimaryProduct: true, passive: true, lineArray: true, minPerSide: 4 },
  { id: 'legacy-cat-17866155692868', cat: '스피커', brand: 'Audiocenter', name: 'T45-Passive', price: 2100000, isPrimaryProduct: true, passive: true, lineArray: true, minPerSide: 4 },
  ...
  { id: 'ac-t8800', cat: '파워앰프', brand: 'Audiocenter', name: 'T8800', price: 1810000, isPrimaryProduct: true },
  { id: 'legacy-cat-178661556928639', cat: '파워앰프', brand: 'Audiocenter', name: 'UTA902DSP', price: 803000, priceIncludesVat: true, isPrimaryProduct: true },
  { id: 'legacy-cat-178661556928641', cat: '파워앰프', brand: 'Audiocenter', name: 'UTA1804DSP', price: 1720000, isPrimaryProduct: true },
  { id: 'POWERSOFT-56615BE24E', cat: '파워앰프', brand: 'Powersoft', name: 'Quattrocanali 1204 DSP', price: 3960000, priceIncludesVat: true, isPrimaryProduct: true },
  { id: 'ac-wm3210a', cat: '모니터스피커', brand: 'Audiocenter', name: 'WM3210A Active-DSP', price: 1100000, isPrimaryProduct: true },
  { id: 'ac-wm3210p', cat: '모니터스피커', brand: 'Audiocenter', name: 'WM3210P Passive', price: 830000, isPrimaryProduct: true, passive: true },
